...
class DeliveryInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery_info" do
    assert_difference('DeliveryInfo.count') do
      post delivery_infos_url, params: { delivery_info: { line1: @delivery_info.line1, line2: @delivery_info.line2, phone: @delivery_info.phone } }
    end
  ...
  test "should update delivery_info" do
    patch delivery_info_url(@delivery_info), params: { delivery_info: { line1: @delivery_info.line1, line2: @delivery_info.line2, phone: @delivery_info.phone } }
